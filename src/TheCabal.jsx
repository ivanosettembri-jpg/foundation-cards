...
function CardImage({ card, style }) {
  ...
  return (
    <div style={{...style, background: imgReady ? undefined : "#0a0a0a",
      display:"flex", alignItems:"center", justifyContent:"center",
      overflow:"hidden", position:"relative", flexShrink:0}}>
      {!imgReady && (
        <div style={{position:"absolute", fontFamily:"'DM Mono',monospace",
          fontSize:7, color:"#1e1e1e", letterSpacing:1.5,
          animation:"pulse 1.8s ease-in-out infinite", pointerEvents:"none"}}>
          loading...
        </div>
      )}
      {src && (

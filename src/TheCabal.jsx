    ...
    >
      <div style={{
        ...
        <div style={{
          ...
          alignItems:"center", justifyContent:"center", gap:22, padding:10,
      ...
      <div style={{
        ...
        >
          ...
          <div style={{ position:"absolute", inset:0 }}>
            ...
            {special ? null : (
              <>
                {/* Standard: large logo top center */}
                <div style={{
            ...
            {special ? (
              ...
              <div style={{
                ...
                <div style={{
                  fontSize: Math.round(PACK_W * 0.058),
                  letterSpacing: 1,
                  color: "rgba(255,255,255,0.36)",
                }}>standard pack</div>
                <div style={{
                  fontSize: Math.round(PACK_W * 0.046),
            ...
            {/* 5 dots + season one — standard pack only */}
            {!special && (<>
            <div style={{
              position:"absolute", top:"79%", left:0, right:0,
              display:"flex", justifyContent:"center", gap:8,
            }}>
              {[0,1,2,3,4].map(i => (
                <div key={i} style={{
                  width: Math.round(PACK_W * 0.030),
                  height: Math.round(PACK_W * 0.030),
                  borderRadius:"50%",
